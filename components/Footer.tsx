        ...
        >
            <div className="max-w-6xl mx-auto px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    {/* Social */}
                    <div>
                        <p className="text-xs font-bold uppercase tracking-widest mb-5" style={{ color: "var(--color-text-primary)" }}>Social</p>
                        <div className="flex gap-4">
                            <a href="#" className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center hover:border-teal-500 transition-colors" style={{ color: "var(--color-text-secondary)" }}>
